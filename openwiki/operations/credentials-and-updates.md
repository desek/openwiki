...
- Claude subscription OAuth token (for the `anthropic-claude` provider): `CLAUDE_CODE_OAUTH_TOKEN`, minted with `claude setup-token` — see [CLI usage](../cli/usage.md#anthropic-claude-subscription)
